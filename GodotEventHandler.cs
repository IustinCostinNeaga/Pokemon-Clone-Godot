...
public partial class GodotEventHandler : Node2D {
    [Signal]
    public delegate void ShowWorldMapEventHandler();

    [Signal]
    public delegate void ShowBattleScreenEventHandler();
    ...
    public void OnBattleReady() {
        GetTree().Root.GetNode<TextureButton>("BattleScreen/Buttons/Run")
